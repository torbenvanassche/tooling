...
@export var moveForwardAction : String = "forward"
@export var moveBackwardAction : String = "backward"
@export var moveLeftAction : String = "left"
@export var moveRightAction : String = "right"
@export var runAction : String = "sprint"
